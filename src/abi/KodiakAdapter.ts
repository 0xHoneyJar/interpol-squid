...
export const functions = {
    ...
    lockTime: viewFun("0x0d668087", "lockTime()", {}, p.uint256),
    ...
    unstake: fun("0xc2a672e0", "unstake(address,uint256)", {"vault": p.address, "kekIdAsUint": p.uint256}, p.uint256),
...
export class Contract extends ContractBase {
    ...
    lockTime() {
        return this.eth_call(functions.lockTime, {})
    }
...
export type LockTimeParams = FunctionArguments<typeof functions.lockTime>
export type LockTimeReturn = FunctionReturn<typeof functions.lockTime>
